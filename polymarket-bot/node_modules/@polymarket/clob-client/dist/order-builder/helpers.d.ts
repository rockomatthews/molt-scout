 ...
 * @returns SignedOrder
 */
export declare const buildOrder: (signer: Wallet | JsonRpcSigner, contractAddress: string, chainId: number, orderData: OrderData) => Promise<SignedOrder>;
...
export declare const createOrder: (eoaSigner: Wallet | JsonRpcSigner, chainId: Chain, signatureType: SignatureType, funderAddress: string | undefined, userOrder: UserOrder, tickSize: TickSize) => Promise<SignedOrder>;
...
export declare const createMarketBuyOrder: (eoaSigner: Wallet | JsonRpcSigner, chainId: Chain, signatureType: SignatureType, funderAddress: string | undefined, userMarketOrder: UserMarketOrder, tickSize: TickSize) => Promise<SignedOrder>;
